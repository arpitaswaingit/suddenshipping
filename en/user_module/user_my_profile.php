                                ...
                                <div class="row" style="padding:10px">
                                 ...
                                 <div class="col-md-6 shadow" style="padding-top:5px;">
                                   ...
                                   for ($i=0; $i <sizeof($per); $i++) 
                                   {
                                       if($per[$i]==5)
                                       { ?>
                                           <li><i class="fa fa-map-marker"></i><span> Locator</span></li>
                                       ...
                                       { ?>
                                           <li class="dropdown"> 
                                               <i class="fas fa-file-upload"></i><span> Support</span>
                                           </li>
                                       <?php }
                                      ...
                                      <?php }
                                       ...
                                       if($per[$i]==13)
                                       { ?>
                                       <li><i class="fa fa-envelope"></i><span> Mail Server Admin</span></li>
