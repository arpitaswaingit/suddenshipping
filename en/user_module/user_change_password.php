                            ...
                            <div class="col-md-5 single_element" style="padding:30px;">
                                <div class="wrapper">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="password" required name="old_pass"  id="old_pass" placeholder="Enter Old Password" required>
                                    </div>
                                    <div class="row">
                                        <i class="fas fa-lock"></i>
                                        <input type="password" required name="new_pass" id="new_pass" placeholder="Enter New Password" required>
                                    </div>
