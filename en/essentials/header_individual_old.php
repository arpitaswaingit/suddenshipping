    ...
    <div class="panel-layout">
        <div class="container-fluid">
            <div class="row">
				...
				<li><a href="" title=""><i class="fa fa-map-marker"></i><span>Dealer Admin</span></a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" style="margin-left:20px">
						...
						<li ><a href="../../../labor_time/admin/skidpro/" style="font-size:13px;text-transform:uppercase">Skid Pro</a></li>
