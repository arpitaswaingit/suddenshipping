			 ...
			 <div class="row row_border">
				...
				<div class="col-md-6">
					...
					<form class="form" method="POST">
						<input type="submit" name="clear"  class="btn btn-secondary bord" value="Clear" />
					</form>                                
                    ...
                    <table id="table_id" class="table  table-striped table-bordered overflow-auto">
                        <thead class="tfont t-head">
                          <tr>
                              ...
                              <th id="1admin">Locator<span style="visibility:hidden">________</span><br>
                              ...
                              <th id="2admin">Sudden<span style="visibility:hidden">_</span>Shipping<span style="visibility:hidden">_</span>Admin<br> 
							  ...
							  <th id="3admin">Support<span style="visibility:hidden">_</span>Admin<br> 
							  ...
							  <th id="4admin">Free<span style="visibility:hidden">_</span>Catalog<span style="visibility:hidden">_</span>Admin<br> 
							  ...
							  <th id="5admin">Online<span style="visibility:hidden">_</span>Price<span style="visibility:hidden">_</span>Admin<br> 
							  ...
							  <th id="9admin">Mail<span style="visibility:hidden">_</span>Server<span style="visibility:hidden">_</span>Admin<br> 
