...
<div id="mySidebar" class="sidebar">
    <ul style="list-style-type:none; width: 240px;">
        ...
        <!-- <li class="support-nav"><a href="welcomelogin.php" style="font-size:13px;"><strong>Home</strong></a></li> -->
        <li class="support-nav"><a href="../../login/en/adminpermission.php" style="font-size:13px;"><strong>User List</strong></a></li>
